 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_rghf')){
	function azrcrv_create_plugin_menu_rghf(){
		azrcrv_create_plugin_menu_table_rghf();
		azrcrv_populate_plugin_menu_table_rghf();
	}
}
 ...
 *
 */
if (!function_exists('azrcrv_populate_plugin_menu_table_rghf')){
	function azrcrv_populate_plugin_menu_table_rghf(){
		global $wpdb;
 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_table_rghf')){
	function azrcrv_create_plugin_menu_table_rghf(){
		global $wpdb;
		$table_name = $wpdb->base_prefix.'azrcrv_plugin_menu';
