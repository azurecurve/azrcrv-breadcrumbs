 ...
 * @since 1.0.0
 */
if ( ! function_exists( 'azrcrv_create_plugin_menu_b' ) ) {
	function azrcrv_create_plugin_menu_b() {
		azrcrv_populate_plugin_menu_b();
	}
}
 ...
 * @since 1.0.0
 */
if ( ! function_exists( 'azrcrv_populate_plugin_menu_b' ) ) {
	function azrcrv_populate_plugin_menu_b() {
